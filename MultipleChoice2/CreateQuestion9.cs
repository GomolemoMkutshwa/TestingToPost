...
{
    public partial class CreateQuestion9 : Form
    {
        public CreateQuestion9()
        {
            InitializeComponent();
        }

        private void CreateQuestion9_Load(object sender, EventArgs e)
        {
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            CreateQuestion10 form = new CreateQuestion10();
            form.Show();
        }
