...
{
    public partial class TakingTheTest : Form
    {
       
        public TakingTheTest()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlDataAdapter cc = new SqlDataAdapter("Select questionNumber, question, optionA,optionB, optionC from CreateTests where questionNumber = '2' ", con);
