...
{
    public partial class CreateQuestion8 : Form
    {
        public CreateQuestion8()
        {
            InitializeComponent();
        }

        private void CreateQuestion8_Load(object sender, EventArgs e)
        {
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            CreateQuestion9 form = new CreateQuestion9();
            form.Show();
        }
