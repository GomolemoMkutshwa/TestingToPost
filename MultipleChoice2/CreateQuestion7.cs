...
{
    public partial class CreateQuestion7 : Form
    {
        public CreateQuestion7()
        {
            InitializeComponent();
        }

        private void CreateQuestion7_Load(object sender, EventArgs e)
        {
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            CreateQuestion8 form = new CreateQuestion8();
            form.Show();
        }
